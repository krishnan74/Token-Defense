...
const STEPS: Step[] = [
  ...
  {
    title: 'RESOURCE BAR',
    body: 'Gold funds your factories.\nTokens power your towers — low tokens mean slower fire and less damage.\nKeep all three token types stocked.',
    anchor: 'top-center',
    arrow: 'up',
    dim: true,
  },
  ...
  {
    title: 'BUILD MENU',
    body: 'Select a tower or factory type here, then click a green tile to place it.\nFactories cost gold but generate tokens every wave.\nMatch factory type to tower type — they share the same token pool.',
  ...
  {
    title: 'TOWER SIDEBAR',
    body: 'Track your towers and factories here.\nUpgrade towers (↑) to boost damage up to +65%.\nUpgrade factories to produce 50% more tokens per level.\nSell (✕) to reposition if needed.',
    anchor: 'mid-right',
    arrow: 'right',
    dim: true,
  },
  ...
  {
    title: 'PRO TIPS',
    body: '◆ Adjacent towers of DIFFERENT types share a +20% synergy bonus.\n◆ Tokens are capped at 150 — build factories before you hit the cap.\n◆ Later enemies face depleted tokens from earlier kills — factories are critical in wave 7+.\n◆ Agents can read all world state via Torii GraphQL and play autonomously.',
    anchor: 'center',
    dim: true,
  },
];
